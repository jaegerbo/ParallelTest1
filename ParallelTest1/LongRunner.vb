Module LongRunner
   ...
   Public Function Test3(Anzahl As Integer) As Integer
      ...
      Return i
   End Function
   Public Function Test4(Anzahl As Integer, cancelationtoken As Threading.CancellationToken, Progress As IProgress(Of Integer)) As Integer
      Dim i As Integer
      Try
         Debug.WriteLine($"Test4 gestartet um {Now.ToLongTimeString}")
         For i = 0 To Anzahl - 1
      ...
      Return i
   End Function
   Public Async Function Test4Async(Anzahl As Integer, cancelationtoken As Threading.CancellationToken, Progress As IProgress(Of Integer)) As Task(Of Integer)
      Try
