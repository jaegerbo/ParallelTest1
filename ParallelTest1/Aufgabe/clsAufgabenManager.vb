...
Public Class clsAufgabenManager
   ...
   Public Async Function starteAufgabe(aufzurufendeFunktion As AufgabenDelegate, Parameterliste As Hashtable,
                                       Optional cancelationtoken As CancellationToken = Nothing) As Task(Of clsAufgabenErgebnis)
